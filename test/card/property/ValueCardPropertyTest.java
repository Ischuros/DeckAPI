...
public class ValueCardPropertyTest
{

	@Test
	public void testOrderPriority()
	{
		ValueCardProperty<Integer, Integer> priority1 = createProperty("a", "b",
				Integer.valueOf(90), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority2 = createProperty("a", "b",
				Integer.valueOf(80), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority3 = createProperty("a", "b",
				Integer.valueOf(70), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority4 = createProperty("a", "b",
				Integer.valueOf(60), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority5 = createProperty("a", "b",
				Integer.valueOf(50), Integer.valueOf(10));

		List<ValueCardProperty<Integer, Integer>> priorities = new ArrayList<>();
	...
	public void testOrderPriorityAndValue()
	{
		...
		ValueCardProperty<Integer, Integer> priority5 = createProperty("a", "b",
				Integer.valueOf(10), Integer.valueOf(80));
		ValueCardProperty<Integer, Integer> priority6 = createProperty("a", "b",
				Integer.valueOf(10), Integer.valueOf(70));
	...
	{
		ValueCardProperty<Integer, Integer> priority1 = createProperty("z", "b",
				Integer.valueOf(10), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority2 = createProperty("y", "b",
				Integer.valueOf(10), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority3 = createProperty("x", "b",
				Integer.valueOf(10), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority4 = createProperty("w", "b",
				Integer.valueOf(10), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority5 = createProperty("v", "b",
				Integer.valueOf(10), Integer.valueOf(10));
	...
	{
		ValueCardProperty<Integer, Integer> priority1 = createProperty("a", "z",
				Integer.valueOf(10), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority2 = createProperty("a", "y",
				Integer.valueOf(10), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority3 = createProperty("a", "x",
				Integer.valueOf(10), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority4 = createProperty("a", "w",
				Integer.valueOf(10), Integer.valueOf(10));
		ValueCardProperty<Integer, Integer> priority5 = createProperty("a", "v",
				Integer.valueOf(10), Integer.valueOf(10));
	...
	private ValueCardProperty<Integer, Integer> createProperty(String name,
			String description, Integer priority, Integer value)
	{
		return new ValueCardProperty<Integer, Integer>(name, description, priority,
				value)
		{
		};
	}
